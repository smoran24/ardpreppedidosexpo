sap.ui.define([
	...
	var superarr = [];
	var oMessagePopover;
	return Controller.extend("AR_DP_REP_PEDIDO.AR_DP_REP_PEDIDO.controller.VerificaInmovilizado", {
		...
		handleValueHelp: function (oEvent) {
			...
			if (!this._valueHelpDialog) {
				this._valueHelpDialog = sap.ui.xmlfragment("AR_DP_REP_PEDIDO.AR_DP_REP_PEDIDO.view.PopUpdescartadosInmovilizado",
					this
				);
  ...
  var appModulePath = jQuery.sap.getModulePath(appid);
		...
		popSucces: function (obj, titulo) {
			...
			if (!oDialog) {
				// create dialog via fragment factory
				oDialog = sap.ui.xmlfragment(oView.getId(), "AR_DP_REP_PEDIDO.AR_DP_REP_PEDIDO.view.Succes", this);
				oView.addDependent(oDialog);
			}
		...
		atras: function () {
			...
			sap.ui.controller("AR_DP_REP_PEDIDO.AR_DP_REP_PEDIDO.controller.CrearPedidoInmovilizado").jsoncreacion(cliente, pedido, destino,
